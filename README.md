...
Используем команду pytest для запуска тестирования.


23.08.2025
Добавлен модуль generators.py и тестовый модуль test_generators.py
Обновлен файл .coverage. 
Изменен модуль main.py
Запуск программы производится из модуля main.py

Тайпинг не покрывает новые модули так как это задание под звездочкой (дополнительное) 
Запуск файла покрытия тестами в формате HTML запускается командой start htmlcov/index.html
